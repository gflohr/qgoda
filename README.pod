L<![GPL-3.0](https://img.shields.io/badge/License-GPLv3-blue.svg)|https://www.gnu.org/licenses/gpl-3.0>
...
Copyright (C) 2016-2025 Guido Flohr L<mailto:guido.flohr@cantanea.com>, all
rights reserved.
